...
comet_ml.init(
    ...
    project_name="kobila_mistakes",
    workspace="icecoldempress",
)
os.environ["COMET_LOG_ASSETS"] = "True"
os.environ["TRANSFORMERS_CACHE"] = "/storage/marijaabsec/training/cache"


#print(transformers.__version__)

checkpoint = "./models/mistakes()_01"

from datasets import load_dataset, load_metric, Dataset

ocr = [line.strip() for line in open(sys.argv[1], "r", encoding="utf-8").readlines()]
orig = [line.strip() for line in open(sys.argv[2], "r", encoding="utf-8").readlines()]
l = len(ocr)
train_percent = l // 10
